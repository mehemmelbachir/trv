...
(function ($, root, undefined) {
	...
	$(function () {
		...
		*/
		...
		var projectCounter = new CountUp("projectCounter", 9538, 930000, 0, 3, options);	
	
		var carreerCounter = new CountUp("carreerCounter", 0, 1000, 0 , 3 , optionCarrer);
		...
		$.scrollify({
		    ...
		    before:function(i,panels) {
				...
				$('.cube').css({ WebkitTransform: 'rotateX(' + degree + 'deg)'});
           		...
           		carreerCounter.reset();
				},

		    after:function(i,panels){		    	
           		projectCounter.start();
           		carreerCounter.start();
		    },
